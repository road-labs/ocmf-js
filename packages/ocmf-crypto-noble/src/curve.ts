...
const secp192k1 = ecdsa(
  weierstrass({
    p: BigInt('0xfffffffffffffffffffffffffffffffffffffffeffffee37'),
    a: BigInt(0),
    b: BigInt(3),
...
export function resolveCurveFn(curve: Curve): ECDSA {
  switch (curve) {
    case 'secp192r1':
      return secp192r1;
    case 'secp192k1':
